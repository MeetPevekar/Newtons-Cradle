...
function setup() {
	...
	rope3=new rope(bobObject4.body,roofObj.body,bobDiameter*1, 0)
	rope4=new rope(bobObject5.body,roofObj.body,bobDiameter*2, 0)
	...
	var pendulum3=Constraint.create(constraint4)
	var pendulum4=Constraint.create(constraint5)
